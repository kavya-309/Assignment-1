...
\begin{align}
\vec{A} = b\myvec{\ cos A \\ \ sin A}
\\
\vec{A} = \myvec{\ 3.89283103 \\ \ 4.47401628}
\end{align}
\end{align}
Now, Vertices of given $\triangle ABC$ can be written as,
\begin{align}
\vec{C} = \myvec{p\\q}=\myvec{2.60416667\\5.40539693}, \vec{A} = \myvec{3.89283103\\4.47401628}, \vec{B} =\myvec{c\\0} = \myvec{5\\0}
\end{align}
\\
