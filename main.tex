...
q =4.5
\end{align}
We now ,use the law of cosin
\begin{align}
b^2 =a^2+c^2-2accos{B}
\\
36=25+20.25-202.5cos{B}
\\
202.5cos{B} =25+20.25-36
\\
202.5cos{B} =9.25
\\
cos{B} =9.25/202.5
...
\begin{align}
\vec{A} = \myvec{p\\q}=\myvec{0\\4.5}, \vec{B} = \myvec{0\\0}, \vec{C} =\myvec{a\\0} = \myvec{5\\0}
\end{align}
\\
 Now, $\triangle ABC$ can be plotted using vertices $AB$ ,$BC$ and $CA$ .
\\
Plot of the Right angle $\triangle ABC$:
\numberwithin{figure}{section}
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{download.png}
    \captiwon{Right Angle $\triangle ABC$}
