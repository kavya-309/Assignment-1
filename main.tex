...
Then
\begin{align}
\norm{\vec{B}-\vec{A}}^2 = \norm{\vec{B}}^2  = c^2 =(4.5)^2 =20.25
\\
\norm{\vec{C}-\vec{A}}^2 = \norm{\vec{C}}^2 =b^2 =6^2 =36
\\
\norm{\vec{B}-\vec{C}}^2 = a^2= 5^2 =25
\end{align}
From(2.0.4)
\\
\begin{aline}
...
\begin{align}
\vec{C} = \myvec{p\\q}=\myvec{2.6041\\4.2006}, \vec{A} = \myvec{0\\0}, \vec{B} =\myvec{a\\0} = \myvec{5\\0}
\end{align}
\\
